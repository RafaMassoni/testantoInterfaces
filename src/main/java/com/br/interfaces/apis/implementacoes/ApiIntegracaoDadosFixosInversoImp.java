...
public class ApiIntegracaoDadosFixosInversoImp implements ApiInterface {


    public void conectar(){
        System.out.println("CONECTADO A DADOS FIXOS INVERTIDO");
    }
    ...
    public ApiInterface proximoAPIaSerValidada() {
        return new ApiIntegracaoDadosAleatoriosImp();
    }

    @Override
    public TipoApiEnumerator tipoDaApi() {
        return TipoApiEnumerator.DADOS_FIXOS_INVERSO;
    }
}
